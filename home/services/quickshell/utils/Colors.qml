...
Singleton {
    ...
    readonly property color bgBar: darkMode ? Qt.rgba(0.17, 0.17, 0.27, 0.42) : Qt.hsla(0, 0, 0.95, 0.11)
    ...
    readonly property list<color> monitorColors: ["#f5c2e7", "#e5c07b", "#98c379", "#61afef"]
